...
Namespace WPFConverters
    ...
    Public Class NumberedBadgeFromBmpImg
...
#Region "Interfaces implementations"
        ...
        Public Function Convert(value As Object, targetType As Type, parameter As Object, culture As CultureInfo) As Object Implements IValueConverter.Convert
            ...
            Dim img As BitmapImage = TryCast(value, BitmapImage)

            If (img IsNot Nothing) And (Number <> "") Then

                Dim stylo As SolidBrush = New SolidBrush(Color.White)
                Dim police As New Font("Tahoma", 5)

                Dim btm As Bitmap = Graphical.ImageConvertions.BitmapImage2Bitmap(img)
