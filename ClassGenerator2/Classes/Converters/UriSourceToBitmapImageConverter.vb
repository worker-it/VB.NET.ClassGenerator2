...
Namespace WPFConverters
    ...
    Public Class UriSourceToBitmapImageConverter
...
#Region "Interfaces implementations"
        ...
        Public Function Convert(value As Object, targetType As Type, parameter As Object, culture As CultureInfo) As Object Implements IValueConverter.Convert
            ...
            Dim aUri As Uri = TryCast(value, Uri)

            If (aUri IsNot Nothing) Then
                Return New BitmapImage(aUri)
            Else
                Return Nothing
            End If
        ...
        Public Function ConvertBack(value As Object, targetType As Type, parameter As Object, culture As CultureInfo) As Object Implements IValueConverter.ConvertBack
            Dim anImage As Image = TryCast(value, Image)

            If (anImage IsNot Nothing) Then
                Return TryCast(anImage.Source, BitmapImage).UriSource
            Else
                Return Nothing
            End If
