...
#Region "Interfaces implementations"
        ...
        Public Function Convert(value As Object, targetType As Type, parameter As Object, culture As CultureInfo) As Object Implements IValueConverter.Convert
            ...
            Dim thk As CornerRadius

            thk = CType(value, CornerRadius)

            If (thk <> Nothing) Then

                Return New CornerRadius(If(TopLeft, thk.TopLeft, 0), If(TopRight, thk.TopRight, 0), If(BottomRight, thk.BottomRight, 0), If(BottomLeft, thk.BottomLeft, 0))
